  ...
  networks: {
    ...
    palmdev: {
      provider: () => new HDWalletProvider({
        providerOrUrl: `https://palm-devnet.infura.io/v3/${infuraKey}`,
        privateKeys: [privKey]
      }),
      network_id: 2021,
      production: true,
    ...
    palmtest: {
      ...
      provider: () => new HDWalletProvider({
        providerOrUrl:`https://palm-testnet.infura.io/v3/${infuraKey}`,
        privateKeys: [privKey]
      }),
    ...
    palm: {
      ...
      provider: () => new HDWalletProvider({
        providerOrUrl: `https://palm-mainnet.infura.io/v3/${infuraKey}`,
        privateKeys: [privKey]
      }),
